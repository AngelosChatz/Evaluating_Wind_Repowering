...
output_excel = results_dir / "Repowering_Calculation_Stage_2_int.xlsx"
...
def main():
    # Read the wind farm data from Excel using the relative path
    input_excel_path = results_dir / "Windfarms_World_20230530_with_IEC_Elevation_v2_area_classifications.xlsx"
    output_excel_path = results_dir / "Repowering_Calculation_Stage_2_int.xlsx"
    ...
    for idx, row in df.iterrows():
        ...
        best_turb, best_ratio, new_turb_count, turbine_area = best_fitting_turbine_for_iec_class(
