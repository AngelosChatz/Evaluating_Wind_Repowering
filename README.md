...
| 11. Repowered_Energy_Production            | <ul><li>`Cf_old_updated.xlsx`</li></ul>   <ul><li>`Approach_*.xlsx` (all approaches)`</li></ul>                                                                                                                     | <ul><li>(Plots)</li></ul>     <ul><li>`Approach_6_No_Loss_Hybrid_Yield_based.xlsx`</li></ul>                                                      |
