...
output_excel = results_dir / "Repowering_Calculation_Stage_2_int_new_rounding_and_singlereplacement.xlsx"
...
def main():
    # Read the wind farm data from the input Excel file
    ...
    # Prepare lists for result values
    recommended_models = []
    ...
    # Add computed values as new columns to the DataFrame
