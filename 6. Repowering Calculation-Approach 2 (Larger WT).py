...
# Define the input and output Excel file paths using relative paths
...
def best_fitting_turbine_for_iec_class_min_turbines(turbine_list, terrain_type, iec_class_num, available_area):
    ...
    for t in matching_turbines:
        ...
        # Choose the candidate with a higher total capacity; if tied, choose the one with fewer turbines.
