...
# Define relative file paths for input and output Excel files
input_excel =results_dir / "Windfarms_World_20230530_with_IEC_Elevation_v2_area_classifications.xlsx"
output_excel = results_dir / "Repowering_Calculation_Stage_2_int_new_rounding.xlsx"
...
def main():
    # Define relative file paths: input from the data folder, output to the results folder
    base_dir = Path(__file__).resolve().parent
    ...
    input_excel = results_dir / "Windfarms_World_20230530_with_IEC_Elevation_v2_area_classifications.xlsx"
    output_excel = results_dir / "Repowering_Calculation_Stage_2_int_new.xlsx"
    ...
    # Convert IEC_Class_Num column to integer if needed
