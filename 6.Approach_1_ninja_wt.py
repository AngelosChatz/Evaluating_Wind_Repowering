...
# ensure IEC_Class_Num exists and is integer
...
for idx, row in df.iterrows():
    ...
    t, ratio, new_count, _ = best_fitting_turbine_for_iec_class(
    ...
    if t is None:
        ...
        total_caps.append(new_count * t["Capacity"])
